...
const CTA = () => {
  return (
    <div className='flex'>
      <Link to='/upcoming' className='flex justify-start text-sm font-semibold text-white bg-indigo-700 py-2 px-4 rounded-full'>
...
const Tech = () => {
  return <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
}
  ...
  return (
    <div className='flex text-black'>
      <div className='flex flex-col'>
        <div className='text-6xl font-bold opacity-100 leading-snug whitespace-pre-line mb-7'>{"Hi! I'm\nHarrison 👋"}</div>
        <div className='text-base font-medium opacity-80 leading-snug'>{"I'm pretty good at coding. In my spare time, I like to create useful apps that help people. My goal is to impact the world one day."}</div>
      </div>
    </div>
  )
}
